...
(function ($) {
    ...
    //設定標頭
    $container.append(
        '<h5>Cloud MS 風格設定</h5><hr class="mb-2"/>'
    )
    //$container.append(
    ...
    var $dark_mode_container =
        $('<div />', { class: 'mb-4' })
            ...
            .append('<span>深色模式 Dark Mode</span>');

    $container.append($dark_mode_container)

    $container.append('<h6>標頭設定 Header Options</h6>')
    ...
    var $header_fixed_container =
        $('<div />', { class: 'mb-1' })
            .append($header_fixed_checkbox)
            .append('<span>固定 Fixed</span>')
    ...
    var $dropdown_legacy_offset_container =
        $('<div />', { class: 'mb-1' })
            ...
            .append('<span>下拉偏移 Dropdown Legacy Offset</span>');
    ...
    var $no_border_container =
        $('<div />', { class: 'mb-4' })
            .append($no_border_checkbox)
            .append('<span>移除邊線 No border</span>');
    $container.append($no_border_container)

    $container.append('<h6>側邊選單設定 Sidebar Options</h6>')
    ...
    var $sidebar_mini_container =
        $('<div />', { class: 'mb-1' })
            .append($sidebar_mini_checkbox)
            .append('<span>側邊選單縮小 Sidebar Mini</span>')
    ...
    $container.append('<h6>底下設定 Footer Options</h6>')
    ...
    var $footer_fixed_container = $('<div />', { class: 'mb-4' }).append($footer_fixed_checkbox).append('<span>固定 Fixed</span>')
    $container.append($footer_fixed_container)

    $container.append('<h6>文字設定 Small Text Options</h6>')
    ...
    var $text_sm_body_container =
        $('<div />', { class: 'mb-1' }).append($text_sm_body_checkbox).append('<span>Body</span>')
    ...
    $container.append('<h6>標頭設定 Navbar Variants</h6>')
